...
use kilyakus\modules\models\Admin;

class AdminsController extends \kilyakus\modules\components\Controller
{
    ...
    public function actionIndex()
    {
        ...
        Yii::$app->user->setReturnUrl(['/system/admins']);
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(Yii::$app->request->isAjax){
                ...
                if($model->save()){
                    ...
                    return $this->redirect(['/system/admins']);
                }
                else{
