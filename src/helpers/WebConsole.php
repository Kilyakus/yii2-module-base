...
class WebConsole
{
    ...
    public static function console()
    {
        if(!self::$_console)
        {
            ...
            $consoleConfigFile = Yii::getAlias('@config/console.php');

            if(!file_exists($consoleConfigFile) || !is_array(($consoleConfig = require($consoleConfigFile)))){
                throw new \yii\web\ServerErrorHttpException('Cannot find `'.Yii::getAlias('@config/console.php').'`. Please create and configure console config.');
            }
    ...
    public static function migrate()
    {
        ...
        self::console()->runAction('migrate', ['migrationPath' => '@app/migrations/', 'migrationTable' => 'migration', 'interactive' => false]);
